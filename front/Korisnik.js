...
export class Korisnik {
    ...
    logovanje(host) {
        ...
        fetch("https://localhost:5001/Koristnik/UlogujSe/" + this.email + "/" + this.sifra + "/" + this.admin)
            .then(s => {
                if (s.ok) {

                    if (this.admin) {
                        let host = this.bioskop.kont.querySelector(".GlavniKontejner");
                        this.bioskop.crtajAdminFormu(host);
                    }
                    ...
                    let host = this.bioskop.kont.querySelector(".GlavniKontejner");
                    this.bioskop.removeAdminFormu(host);
                    throw s;
